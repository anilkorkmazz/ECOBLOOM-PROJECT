            ...
            <div className="mx-auto max-w-2xl py-32 sm:py-48 lg:py-56">
                ...
                <div className="text-center">
                    <h1 className="text-5xl font-semibold tracking-tight text-balance text-gray-900 sm:text-7xl">
                        Doğru Bitkiyi, Doğru Yerde Keşfet
                    </h1>
                    <p className="mt-8 text-lg font-medium text-pretty text-gray-500 sm:text-xl/8">
                        Hava durumu, şehir bilgisi ya da sohbet botumuzla sana en uygun bitkiyi birlikte bulalım. Teknolojiyle doğayı birleştiriyoruz.
                    </p>
                    <div className="mt-10 flex items-center justify-center gap-x-6">
                        ...
                        <ScrollLink to="features" smooth={true} duration={500} className="text-sm font-semibold text-gray-900 cursor-pointer">
                            Daha Fazla Bilgi Al <span aria-hidden="true">→</span>
                        </ScrollLink>
